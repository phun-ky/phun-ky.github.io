...
const TEMPLATE_PATH = resolve(
  DIR_NAME,
  '../../src/pages/Packages/template.html'
);
const TEMPLATE = fs.readFileSync(TEMPLATE_PATH, 'utf-8');
const pathToDir = join(DIR_NAME, '../../dist/packages');
const pathToFrontpage = join(DIR_NAME, '../../dist/packages/index.html');
...
html = html.replace(/{{PACKAGES_CSS}}/, PackagesCSS());
html = html.replace(/{{PACKAGES_JS}}/, PackagesJS());
